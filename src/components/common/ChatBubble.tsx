...
const initialMessages: Message[] = [
  {
    id: 1,
    text: "Hello! I'm Pulkit Rai's Portfolio Assistant. How can I help you?",
    sender: 'bot',
    ...
    >
      <ExpandableChatHeader>
        <div className="flex items-center space-x-3">
          <Avatar className="border-primary h-8 w-8 border-2 bg-red-950">
            ...
            {messages.map((message) => (
              ...
              >
                <div className="flex items-start space-x-2">
                  {message.sender === 'bot' && (
                    <Avatar className="border-primary h-6 w-6 border-2 bg-red-950">
                      <AvatarImage src="/assets/logo.png" alt="Assistant" />
                      <AvatarFallback>AI</AvatarFallback>
                    </Avatar>
                  )}
